...
class TodayScreen extends StatelessWidget {
  ...
  const TodayScreen({Key key, @required this.model}) : super(key: key);
  @override
                ...
                child: CustomScrollView(slivers: <Widget>[
                  ...
                  SliverGrid(
                    ...
                    delegate: SliverChildBuilderDelegate(
                      (BuildContext context, int index) {
                        return Padding(
                          ...
                          child: ImageTextCard(
                            album: model.getAvailableAlbums()[1],
                            model: model,
                            padding: 10,
                          ),
                        );
                    ...
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount: 2,
                      crossAxisSpacing:
                          5, //space btn two images in grid up and down
                      mainAxisSpacing:
                          5, //space btn two images in grid left and right
                    ),
                  ),
                  SliverList(
